    ...
    <div class="navContainer" v-if="navStatus">
      ...
      <div class="markContainer">
        <ul class="markListGroup">
          ...
          <li class="markListItem" @click="addStrikethrough" title="strikethrough"><i class="pcon pcon-strikethrough" aria-hidden="true"></i></li>
          ...
          <li class="markListItem" @click="addQuote" title="quote"><i class="pcon pcon-quote" aria-hidden="true"></i></li>
          <li class="markListItem" @click="addCode"><i class="pcon pcon-code" aria-hidden="true"></i></li>
          <li class="markListItem" @click="addLink"><i class="pcon pcon-link" aria-hidden="true"></i></li>
          <li class="markListItem" @click="addImage"><i class="pcon pcon-picture" aria-hidden="true"></i></li>
          <li class="markListItem" @click="addTable" title="table"><i class="pcon pcon-table" aria-hidden="true"></i></li>
          <li class="markListItem" @click="addUl" title="ul-list"><i class="pcon pcon-list" aria-hidden="true"></i></li>
          <li class="markListItem" @click="addOl" title="ol-list"><i class="pcon pcon-listol" aria-hidden="true"></i></li>
          <li class="markListItem" @click="fullPageFn" title="fullpage"><i class="pcon pcon-full-screen" aria-hidden="true"></i></li>
          <li class="markListItem" @click="previewFn" title="preview"><i class="pcon pcon-eye-slash" aria-hidden="true"></i></li>
          <li class="markListItem" @click="previewAllFn" title="previewAll"><i class="pcon pcon-eye" aria-hidden="true"></i></li>
        </ul>
      </div>
    </div>
...
import range from 'static/until/rangeFn.js'
...
export default {
  ...
  methods: {
    ...
    setStrong () {
      let textareaDom = document.querySelector('.mdEditor')
      range.getCursortPosition(textareaDom)
    },
    addLine () {
      insertContent('\n----\n', this)
    },
